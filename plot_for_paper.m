...
if exist('XYZ', 'var') && exist('vehicle_local_position_t', 'var') && ...
   ...
   exist('vis_vtol_intervals', 'var') && ~isempty(vis_vtol_intervals)
    ...
    % --- named colors ---
    c_hover   = sty.color.vtol_state_1;
    c_trans   = sty.color.vtol_state_3;
    c_fw_pre  = sty.color.setpoint3;
    c_fw_gust = sty.color.response3;
    c_fw_post = sty.color.response8;
    ...
    plot3(XYZ(1,2), XYZ(1,1), -XYZ(1,3), 'ko', 'MarkerSize', 6, ...
